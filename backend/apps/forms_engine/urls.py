...
urlpatterns = [
    ...
    path("form-templates/<int:pk>/sections/<int:sid>/headings/",    views.HeadingListCreateView.as_view()),
    path("form-templates/<int:pk>/sections/<int:sid>/headings/<int:hid>/", views.HeadingDetailView.as_view()),
