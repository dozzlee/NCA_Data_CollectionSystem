...
export default function WorkbookImportPreviewPage() {
  ...
  useEffect(() => {
    ...
    setSchemaText(current => {
      const emptyEditor = !current.trim() || current.trim() === "{}";
      return emptyEditor ? JSON.stringify(item.detected_schema ?? {}, null, 2) : current;
    });
  ...
  const save = useMutation({
    ...
    onSuccess:()=>toast("Workbook mapping saved.","success"),
